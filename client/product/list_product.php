        ...
        <div class="col-lg-3 col-md-4">
            ...
            <!-- <div class="bg-light p-4 mb-30">
                <form>
                    ...
                    <div class="custom-control custom-checkbox d-flex align-results-center justify-content-between">
                    ...
                    <!-- <div class="col-12">
                        <nav>
                          <ul class="pagination justify-content-center">
                            <li class="page-result disabled"><a class="page-link" href="#">Previous</span></a></li>
                            <li class="page-result active"><a class="page-link" href="#">1</a></li>
                            <li class="page-result"><a class="page-link" href="#">2</a></li>
                            <li class="page-result"><a class="page-link" href="#">3</a></li>
                            <li class="page-result"><a class="page-link" href="#">Next</a></li>
                          </ul>
                        </nav>
                    </div> -->
                </div>
