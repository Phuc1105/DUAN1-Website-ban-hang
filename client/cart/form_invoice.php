                        ...
                        <tbody class="align-middle">
                            <?php foreach ($_SESSION['cart'] as $index => $item) :?>
                                <tr>
                                    ...
                                    <td class="align-middle"><?= number_format($item['price'], 0, ".") ?> $</span><input type="hidden" class="don_gia_an" name="price" value="<?= $item['price'] ?>"></td>
                                    <td class="align-middle"><?= number_format($item['discount'], 0, ".") ?></span> $ <input type="hidden" class="giam_gia_an" name="discount" value="<?= $item['discount'] ?>"></td>
                                    ...
                                    <td class="align-middle"> <span class="thanh_tien_sp " id="thanh_tien_sp_<?= $index ?>" data-price="<?= $item['price'] ?>" data-discount="<?= $item['discount'] ?>"><?= number_format($item['total'], 0, ".") ?></span> $</td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                    ...
                    <div class="bg-light p-30 mb-5">
                        ...
                        <div class="border-bottom pb-2">
                            <div class="d-flex justify-content-between mb-3">
                                <h6>Order price</h6>
                                <h6><span class="thanh_tien_sp " id="thanh_tien_sp_<?= $index ?>" data-price="<?= $item['price'] ?>" data-discount="<?= $item['discount'] ?>"><?= number_format($item['total'], 0, ".") ?></span> $</h6>
                            </div>
                        ...
                        <div class="pt-2">
                            <div class="d-flex justify-content-between mt-2">
                                <h5>Total</h5>
                                <h5><?= number_format($totalAll, 0, ".") ?>$</h5>
                            </div>
